...
class TestDeviceShowSerial(base.TestCase):
    ...
    def test_take_action(self, m_dev_obj):
        ...
        with m_base:
            ...
            self.assertEqual(t_result[1][4], m_mod_dev.port)
            self.assertEqual(t_result[1][5], m_mod_dev.baudrate)
            self.assertEqual(t_result[1][6], m_mod_dev.bytesize)
            self.assertEqual(t_result[1][7], m_mod_dev.parity)
            self.assertEqual(t_result[1][8], m_mod_dev.stopbits)
            self.assertEqual(t_result[1][9], m_mod_dev.timeout)
